...
urlpatterns = [
    ...
    path('api/product-qa/', include('apps.product_qa.urls')),
    path('api/product-compare/', include('apps.product_compare.urls')),
    path('api/browsing-history/', include('apps.browsing_history.urls')),
